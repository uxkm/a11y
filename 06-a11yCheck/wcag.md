...
kwcag 2.1 기준 접근성은 크게 세 가지 주요 구성 요소로 나눌 수 있습니다. 원칙 (Principles), 지침 (Guidelines), 검사 항목 (Requirements). 원칙은 4 가지 기본 원칙에 기초혀며, 원칙을 구현하기 위해 13개의 지침을 따라야 하고, 각 지침의 준수 여부를 확인하기 위해 24개의 검사 항목을 마련해야 합니다.    
...
WCAG 2.1 Guidelines : [Guideline 1.1 Text Alternatives](https://www.w3.org/TR/WCAG21/#text-alternatives){: target="_blank"}   
WCAG KO 2.1 Guidelines : [Guideline 1.1 Text Alternatives](http://www.kwacc.or.kr/WAI/wcag21/#text-alternatives){: target="_blank"}   
...
WCAG 2.1 Guidelines : [Guideline 1.2 Time-based Media](https://www.w3.org/TR/WCAG21/#time-based-media){: target="_blank"}   
WCAG KO 2.1 Guidelines : [Guideline 1.2 Time-based Media](http://www.kwacc.or.kr/WAI/wcag21/#time-based-media){: target="_blank"}   
...
WCAG 2.1 Guidelines : [WCAG Use of Color](https://www.w3.org/TR/WCAG21/#use-of-color){: target="_blank"}   
WCAG KO 2.1 Guidelines : [WCAG Use of Color](http://www.kwacc.or.kr/WAI/wcag21/#use-of-color){: target="_blank"}   
